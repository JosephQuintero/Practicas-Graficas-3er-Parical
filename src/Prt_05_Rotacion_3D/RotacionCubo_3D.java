...
public class RotacionCubo_3D extends JPanel implements KeyListener {
    ...
    public static JFrame generarFrame() {
        ...
        frame.setTitle("Cubo 3D con Rotación");
        frame.setSize(700, 580);
        frame.setResizable(false);
        frame.setLocationRelativeTo(null);
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.add(new RotacionCubo_3D());
        return frame;
    }
    ...
    public void keyPressed(KeyEvent e) {
        ...
        switch (key) {
            case KeyEvent.VK_W, KeyEvent.VK_UP:
                anguloX += Math.PI / 36; // Rotar hacia arriba
                rotar(anguloX, anguloY, anguloZ);
                break;
            case KeyEvent.VK_S, KeyEvent.VK_DOWN:
                anguloX -= Math.PI / 36; // Rotar hacia abajo
                rotar(anguloX, anguloY, anguloZ);
                break;
            case KeyEvent.VK_A, KeyEvent.VK_LEFT:
                anguloY += Math.PI / 36; // Rotar hacia la izquierda
                rotar(anguloX, anguloY, anguloZ);
                break;
            case KeyEvent.VK_D, KeyEvent.VK_RIGHT:
                anguloY -= Math.PI / 36; // Rotar hacia la derecha
                rotar(anguloX, anguloY, anguloZ);
                break;
            default:
                break;
